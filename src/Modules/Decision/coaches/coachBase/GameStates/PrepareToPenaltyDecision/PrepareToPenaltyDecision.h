#ifndef VSS_BASE_SOFTWARE_PREPARETOPENALTYDECISION_H
#define VSS_BASE_SOFTWARE_PREPARETOPENALTYDECISION_H
...
#endif // VSS_BASE_SOFTWARE_PREPARETOPENALTYDECISION_H
